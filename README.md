...
## <img src="https://github.com/user-attachments/assets/a6e4d77f-56d6-4aa8-8278-0f5a18ef5eb9" width="24px"> **What Makes Jos AI Resume Analyzer Different?**  
...
2. 🎨 **Jos AI-Powered Resume Builder:**  
...
Follow these steps to run Jos Resume AI:  

#### **Setup Instructions** 🛠️

Follow the steps below to set up and run the **Jos AI Resume Analyzer** on your local machine.
...
Open a terminal and run:
   ...
   ```bash
   git clone https://github.com/Joelndanga/Jos-AI-Resume-Analyzer
   cd Jos-AI-Resume-Analyzer
   ```
...
1. Build the Docker image:
   ```bash
   docker build -t jos-resume-analyzer .
   ```

2. Run the container:
   ```bash
   docker run -p 8501:8501 -e GOOGLE_API_KEY=your_key jos-resume-analyzer
   ```
...
##  <img src="https://github.com/user-attachments/assets/5b3cb883-6652-4525-a352-b4b9a3501e07" width = 35px height = 35px> **Why Users Love Jos Resume AI**  
...
## <img src="https://github.com/user-attachments/assets/e5ac1371-6ac4-48b6-b95c-5ef9afaf1353" width="30"> **Features That Set Jos Resume AI Apart**  
